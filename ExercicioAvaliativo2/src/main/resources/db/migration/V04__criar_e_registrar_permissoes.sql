...
-- admin
INSERT INTO user (id, name, email, password, active_user) values (3, 'Administrador', 'admin@ifsp.edu.br', '$2a$10$eOaGkPpaJaG8LrhcWOaKTOQOM15LZdoW10jImmjjVpdLJsmMA5hfq', 1);
